 ...
 * @author kenne
 */
@WebFilter(filterName = "FilterPrivellege", urlPatterns = {"/Parametrage/*", "/Securite/*", "/Traitement/*", "/Analyse/*"})
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (session.getAttribute("user") != null) {
            ...
            if ("/login.html".equals(hRequest.getRequestURI())) {
                request.getRequestDispatcher("/faces/index.html?faces-redirect=true").forward(request, response);
            }
